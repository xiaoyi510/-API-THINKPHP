    ...
    <form action="<?php echo U();?>" method="post" class="form">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <label>
                <input type="radio" name="is_super" value="0" checked="checked">普通用户</label>
            </div>
            <div class="input-group">
                <label>
                <input type="radio" name="is_super" value="1">管理员</label>
            </div>
            <div class="input-group">
                <label>
                <input type="radio" name="is_super" value="2">超级管理员</label>
            </div>
        </div>
